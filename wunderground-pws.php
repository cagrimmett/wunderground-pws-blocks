...
// Humidity scale colors https://community.windy.com/assets/uploads/files/1628145080761-97c3b4ac-8f8e-4166-8322-bd145bbe8b3b.jpeg
		...
		$output             .= '<div class="top-line">';
				...
				$output     .= '<div class="humidity bordered-grid-item" style="background-color: ' . getBackgroundColor($humidity, $humidity_colors) . '; color: ' . getTextColor($humidity, $humidity_colors) . '"><div class="main">' . $humidity . '%<span class="label">Humidity</span></div><img src="/wp-content/uploads/wu-pws/humidityAvgs-sparkline.png" style="filter: invert('. invertSparkline($humidity, $humidity_colors) .')" /></div>';
			$output         .= '</div>';
